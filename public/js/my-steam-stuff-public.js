(function( $ ) {
  ...
  $(document).ready(function () {
    ...
    var gameListContainer = $('#mss-game-list');
    ...
    $.getJSON(
      ...
      function (data) {
        ...
        gameListContainer.masonry({
          gutter: 10,
          'appended': gridItemContent
        });
        gameListContainer.imagesLoaded().progress( function() {
          gameListContainer.masonry('layout');
        });
      }
    );
  });
